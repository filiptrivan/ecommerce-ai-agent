...
export class TranslateClassNamesGeneratedService {
    ...
    translate = (name: string): string => {
        ...
        {
            case 'Agent':
                return this.translocoService.translate('Agent');
            case 'AgentMainUIForm':
                return this.translocoService.translate('AgentMainUIForm');
            case 'AgentSaveBody':
                return this.translocoService.translate('AgentSaveBody');
            case 'AuthResult':
            ...
            case 'QdrantProduct':
                return this.translocoService.translate('QdrantProduct');
            case 'ReadonlyObject':
